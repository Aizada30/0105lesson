...
//       Triangle triangle = new Triangle();//Main
//       triangle.a=5;
//       triangle.b=3;
//       triangle.c=4;
//
//       triangle.area();
       /** MyClass деген класс тузунуз
        ...
        myclass.nameofPerson="Aizada";
        myclass.lastname="Abdyrazakova";
        myclass.age=20;
        myclass.tableofPeaksoft  =new String[]{"prak","softskills","english"} ;
        myclass.nameofCar="Bugaty";
    }
